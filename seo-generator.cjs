...
<html lang="${lang === 'hi' ? 'hi-IN' : 'en-IN'}">
  <head>
    ...
    <link rel="icon" type="image/jpeg" href="/toppay-logo.jpeg" />
    <link rel="apple-touch-icon" href="/toppay-logo.jpeg" />
...
/* robots.txt --------------------------------------------------------- */
const robots = `# https://web-toppay.in/robots.txt
User-agent: *
Allow: /
...
# Allow crawling of redirects and error pages so crawlers can process
# their redirect responses and noindex metadata.

# Media and asset crawling is allowed
Allow: /assets/
Allow: /toppay-logo.jpeg
Allow: /toppay-og.png
...
const manifest = {
  ...
  icons: [
    { src: '/toppay-logo.jpeg', sizes: '640x640', type: 'image/jpeg', purpose: 'any maskable' },
  ],
};
